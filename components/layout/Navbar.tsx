...
<<<<<<< HEAD
<<<<<<< HEAD
import { Heart, Menu, X, ChevronDown, User, LogOut, LayoutDashboard, Building2, Phone, Award } from 'lucide-react';
=======
...
<<<<<<< HEAD
            {/* Saved count */}
            <Link href="/saved" className="relative p-2 text-slate-300 hover:text-brand-gold transition-colors rounded-lg hover:bg-white/5">
                    ...
                    <div className="p-1.5">
                      ...
                      {user.isAdmin && (
                        <Link href="/admin" onClick={() => setUserMenuOpen(false)}
                          className="flex items-center gap-2.5 px-3 py-2 text-sm text-brand-gold hover:text-amber-400 hover:bg-slate-800 rounded-lg transition-colors">
