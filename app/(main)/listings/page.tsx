...
import { Pagination, EmptyState } from '@/components/ui/Display';
...
export default function ListingsPage() {
  ...
  const { results, total, page, setPage, totalPages } = useListings(filters);
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400 mt-1">{total} properties found</p>
          </div>
